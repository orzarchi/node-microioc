...
class IOC {
    ...
    _construct(typeBinding, resolveChain, additionalArgs) {
        additionalArgs = additionalArgs || [];

        var type = typeBinding.type;
        ...
        instance._iocConstructedFromId = typeBinding.id;
    ...
    _resolveInternal(id, resolveChain, additionalArgs) {
        ...
        if (typeBinding.singleton) {
            ...
            if (!constructedInstance) {
                this._singletons.set(singletonInstanceKey, this._construct(typeBinding, resolveChain, additionalArgs));
            ...
            const instance = this._construct(typeBinding, resolveChain, additionalArgs);
            resolveChain.pop();
            return instance;
        }
    }
